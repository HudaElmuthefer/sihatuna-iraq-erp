...
// المُصدَرة من الإدمن أعلاه). قبل هذا المسار، لم تكن هناك أي طريقة لمستخدم
// عادي (غير إدمن) لتغيير كلمة مروره بنفسه إطلاقاً — كان يجب أن يطلب من الإدمن كل مرة.
// (بدون فحص منشأة هنا عمداً — كل مستخدم يغيّر كلمة مروره الخاصة فقط، بغض
// النظر عن منشأته، فلا يوجد احتمال وصول عبر منشأة ثانية أصلاً)
...
// بعد، راجع utils/db.js) بدل جدول عام، لأن كل مستخدم يملك تخطيطه الخاص
