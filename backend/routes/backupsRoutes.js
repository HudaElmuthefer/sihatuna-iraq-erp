...
//
// ── إصلاح أمني ────────────────────────────────────────────────────────────
// كل هذه المسارات تتطلب **إدمن عام (مستوى الوزارة)** حصراً، وليس أي إدمن —
...
// واحدة (كان يستطيع نظرياً استعادة نسخة قديمة تمسح تعديلات حديثة بمنشآت ثانية
// غيره بالكامل). نفس المنطق ينطبق على سجل التدقيق الشامل — راجع
