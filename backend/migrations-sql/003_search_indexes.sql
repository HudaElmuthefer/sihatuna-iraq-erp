...
-- وهذا النمط (بحث بأي مكان بالنص، مو بس بداية النص) لا يستفيد من فهرس عادي
...
-- بالثانية. لو لاحظتِ مستقبلاً بطء بعمليات الحفظ تحديداً (مو القراءة)،
-- هذا أول مكان تراجعينه (احذفي الفهارس أدناه لو صار عبء بدل فائدة).
