...
// callAIWithImage من منظور أي مسار يستدعيهما — راجعي المرحلة الخامسة
...
// بعد ذلك (هذا هو معنى "غير متصل" هنا) — بعكس Gemini/Claude اللي يتوقفان
// فوراً بلا إنترنت.
//
...
// فقط إن الخادم نفسه شغّال). مهلة قصيرة عمداً (فحص توفّر، لا استدعاء حقيقي).
