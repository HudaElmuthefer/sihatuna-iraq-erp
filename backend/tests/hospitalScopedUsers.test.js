...
// محدَّد) يجب ألا يشوف أو يدير مستخدمين بمنشآت ثانية غيره، بينما إدمن عام
...
describe('إدمن محلي (hospitalId محدَّد) — يشوف ويدير بس منشأته', () => {
  test('GET /users يرجع فقط مستخدمي نفس المنشأة، مو مستخدمي منشآت ثانية', async () => {
...
describe('إدمن عام (بدون hospitalId) — يشوف ويدير الجميع', () => {
