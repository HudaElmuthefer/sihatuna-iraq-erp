...
// مو requireAdmin العادي. إدارة قائمة المنشآت نفسها (إضافة/حذف مستشفى، تعديل
// بياناته) عملية تلمس النظام كله، لا معنى لتفويضها لإدمن محلي مرتبط بمنشأة
// واحدة — إدمن محلي لمستشفى معيّن ما ينبغي يقدر يعدّل بيانات مستشفى ثانٍ أو
// يحذفه، حتى لو كان "admin" بدوره. راجعي middleware/requireGlobalAdmin.js.
