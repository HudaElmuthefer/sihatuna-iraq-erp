-- توسيع جدول dosage_limits (راجعي migrations-sql/009_dosage_limits.sql للبنية
...
-- تلقائياً لطبقة AI الاحتياطية (التي تقدر توضح هذي النقطة بالضبط بدل رقم
...
INSERT INTO dosage_limits (drug_name, min_age, max_age, min_weight_kg, max_weight_kg, max_daily_dose, unit, notes, recommendation) VALUES
  ...
  ('سيبروفلوكساسين', 18, NULL, 50, NULL, 1500, 'mg', 'سقف البالغين لالتهابات معقّدة (750 مجم كل 12 ساعة)؛ التهابات بسيطة تحتاج جرعة أقل عادة', 'استخدمي أقل جرعة فعالة حسب نوع وشدة الالتهاب'),
  ...
  -- سقف مدروس 20 مجم/يوم (جرعات أعلى غير مدروسة بهذي الفئة)؛ سقف
  -- البالغين 80 مجم/يوم. المصدر: GoodRx Atorvastatin Dosage، Drugs.com
  -- Atorvastatin.
  ('أتورفاستاتين', 10, 17, NULL, NULL, 20, 'mg', 'لعلاج فرط الكوليسترول العائلي بالمراهقين — الجرعات فوق 20 مجم لم تُدرَس بهذي الفئة العمرية (باستثناء حالات نادرة متجانسة الشكل بإشراف متخصص)', 'يحتاج إشراف طبيب أطفال متخصص بأمراض القلب/الأيض'),
  ...
  -- Dosage Guide.
  ('ميترونيدازول', 0, 17, 3, 70, 2250, 'mg', '30-40 مجم/كجم/يوم مقسَّمة كل 8 ساعات تقريباً؛ هذا السقف يعكس الحد الأقصى المرجعي (2.25 غم/يوم) لا الجرعة القياسية الأقل', 'استخدمي الجرعة القياسية إلا لو وصف الطبيب جرعة أعلى صراحة لالتهاب شديد'),
  ...
  ('كلاريثروميسين', 18, NULL, 70, NULL, 1000, 'mg', 'سقف البالغين (500 مجم كل 12 ساعة) لالتهابات المتفطرات؛ التهابات أخرى قد تحتاج جرعة أقل (250-500 مجم كل 12 ساعة)', 'استخدمي أقل جرعة فعالة حسب نوع الالتهاب'),
