...
-- الأعمدة الجديدة فقط لو احتجتِ ذلك.
--
-- بعد تشغيل هذا الملف، لازم كمان تطبّقي تعديل الكود المرفق بملف modules.js
-- (راجعي رسالة Claude) حتى يبدأ النظام فعلياً يقرأ/يكتب من الأعمدة الجديدة.
-- ============================================================================
...
-- صار زائداً الآن بما إن specialization عمود حقيقي مفهرس — احذفيه للتنظيف
-- (اختياري، ما يسبب أي ضرر لو تركتيه، بس يوفّر مساحة بسيطة بدون فائدة):
