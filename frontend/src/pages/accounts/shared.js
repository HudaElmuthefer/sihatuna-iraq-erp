...
// أصغر. نُقلت هذي المحتويات بالضبط (نسخ حرفي، بدون أي تعديل منطقي).
...
// ── إصلاح: كانت هذي بيانات تجريبية وهمية (معاملات مالية، ترفيعات، علاوات
...
// ── إصلاح: كانت هذي بيانات رواتب وهمية (4 موظفين برواتب وعلاوات وخصومات
