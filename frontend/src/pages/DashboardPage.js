...
// كل مفتاح هنا يقابل قسماً كاملاً بالصفحة (راجع DEFAULT_DASHBOARD_WIDGETS
...
export default function DashboardPage() {
  ...
  // تظهر بالقائمة بعلامة غير محدَّدة)، حتى يستطيع المستخدم إعادة إظهارها لاحقاً
    ...
    <div>
      ...
      <div className="hero-banner">
        ...
        {/* ── الشعار بالترويسة الرئيسية للوحة التحكم فقط (استثناء مقصود) ──────
            ...
            (راجع HealthBanner.js وPageBanner.js) — هذه اللافتة الوحيدة التي
      ...
      {renderBlocks.map((b) => {
        ...
        if (b.type === 'bottom-grid') {
          ...
          // ودجت واحد فقط ظاهر: يُعرَض بعرض كامل بدل عمود فارغ بجانبه.
          if (b.order.length === 2) {
            return (
