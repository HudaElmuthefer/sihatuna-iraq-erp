...
// الـ API (عبر Postman مثلاً، أو كود خبيث) كان يقدر يرسل بيانات فارغة أو من
// نوع خاطئ وتُقبل مباشرة وتُكتب في قاعدة البيانات.
//
...
// قبل هذا التعديل ما كان في أي حد أقصى لطول النصوص — حقل مثل "الاسم" كان
...
// 5000 حرف لأي حقل نصي ما له maxLength مخصَّص بالمخطط — كافٍ جداً لأطول
// حقل نصي منطقي بالنظام (ملاحظات، عناوين...)، ويقدر أي حقل يحدد رقماً أصغر
// أو أكبر صراحة بمخططه الخاص لو احتاج.
